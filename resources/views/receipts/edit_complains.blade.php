...
@section('subtitle', 'Edit Compalins')
...
@section('content_body')
    ...
    <div class="card mt-5">
        <h2 class="card-header">Edit complains</h2>
        <div class="card-body">

            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a class="btn btn-primary btn-sm" href="{{ route('receipts.process') }}"><i class="fa fa-arrow-left"></i> Back</a>
            </div>

            <form action="{{ route('receipts.updateComplains',$receipt->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-sm-8">
